    ...
    public void initViews(){
        ...
        binding.imDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Dialog delete_di = new Dialog(activity);
                delete_di.setCancelable(false);
                delete_di.setContentView(R.layout.delete_dialog);
                delete_di.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT ));
                delete_di.show();

                TextView ok =delete_di.findViewById(R.id.agree);
                TextView cancel =delete_di.findViewById(R.id.refuse);
